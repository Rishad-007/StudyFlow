      ...
      <div className="border-b border-gray-100 px-4 py-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-200 py-2 pr-3 pl-9 text-sm outline-none focus:border-indigo-500"
          />
        </div>
      </div>
        ...
        <div className="flex items-center justify-between border-t border-gray-100 px-4 py-3">
          ...
          <div className="flex gap-1">
            <button
              ...
              disabled={page === 0}
              className="rounded-lg px-3 py-1.5 text-xs font-medium text-gray-600 transition-colors hover:bg-gray-100 disabled:opacity-30"
            >
              Prev
            </button>
            <button
